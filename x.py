...
creator =['u06165f26b64fcfb4ba47fb13191466bc','u787d6464e208dad899bdc1f80eaf9284','u6ef9e80ab0abb7f5a429172abb52eb8c','u93753aa39065cc81334e25a8d787444a','u716b5a00974df0304c1f996631368924']
admin =['u06165f26b64fcfb4ba47fb13191466bc','u787d6464e208dad899bdc1f80eaf9284','u6ef9e80ab0abb7f5a429172abb52eb8c','u93753aa39065cc81334e25a8d787444a','u716b5a00974df0304c1f996631368924']
owners =['u06165f26b64fcfb4ba47fb13191466bc','u787d6464e208dad899bdc1f80eaf9284','u6ef9e80ab0abb7f5a429172abb52eb8c','u93753aa39065cc81334e25a8d787444a','u716b5a00974df0304c1f996631368924']
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                ...
                cl.sendMessage(op.param1, "感謝您加入淫蕩為好友！".format(str(contact.displayName)))
                cl.sendMessage(op.param1, "歡迎邀請我加群組喔!")
                cl.sendContact(op.param1, "u787d6464e208dad899bdc1f80eaf9284")
        if op.type == 1:
            print ("[1]更新配置文件")
...
#==============================================================================#
                    ...
                    start = time.time()
                    cl.sendMessage(to, "冥魔军に栄光测速中...請稍等")
